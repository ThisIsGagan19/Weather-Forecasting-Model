...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/gagan/project/env/bin',
 'BINLIBDEST': '/Users/gagan/project/env/lib/python3.10',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/gagan/project/env/lib '
              '-L/Users/gagan/project/env/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-isystem '
           '/Users/gagan/project/env/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/gagan/project/env/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/Users/gagan/project/env' "
                "'--build=arm64-apple-darwin20.0.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Users/gagan/project/env/share/zoneinfo:/Users/gagan/project/env/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Users/gagan/project/env/include' "
                "'--with-tcltk-libs=-L/Users/gagan/project/env/lib "
                ...
                '-mmacosx-version-min=11.1 '
                "-I/Users/gagan/project/env/include' "
                "'PKG_CONFIG_PATH=/Users/gagan/project/env/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/Users/gagan/project/env/include',
 'CONFINCLUDEPY': '/Users/gagan/project/env/include/python3.10',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/gagan/project/env '
             '/Users/gagan/project/env/lib '
             '/Users/gagan/project/env/lib/python3.10 '
             '/Users/gagan/project/env/lib/python3.10/lib-dynload',
 'DESTLIB': '/Users/gagan/project/env/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/Users/gagan/project/env/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/gagan/project/env/include '
                   '/Users/gagan/project/env/include '
                   '/Users/gagan/project/env/include/python3.10 '
                   '/Users/gagan/project/env/include/python3.10',
 'INCLUDEDIR': '/Users/gagan/project/env/include',
 'INCLUDEPY': '/Users/gagan/project/env/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/Users/gagan/project/env/lib/python3.10',
 'LIBDIR': '/Users/gagan/project/env/lib',
 'LIBFFI_INCLUDEDIR': '/Users/gagan/project/env/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/gagan/project/env/lib/pkgconfig',
 'LIBPL': '/Users/gagan/project/env/lib/python3.10/config-3.10-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/gagan/project/env/lib/python3.10',
 ...
 'MANDIR': '/Users/gagan/project/env/share/man',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/gagan/project/env/include',
 'OPENSSL_LDFLAGS': '-L/Users/gagan/project/env/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/gagan/project/env/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/Users/gagan/project/env/include',
 'TCLTK_LIBS': '-L/Users/gagan/project/env/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/gagan/project/env/share/zoneinfo:/Users/gagan/project/env/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'datarootdir': '/Users/gagan/project/env/share',
 'exec_prefix': '/Users/gagan/project/env',
 'prefix': '/Users/gagan/project/env',
