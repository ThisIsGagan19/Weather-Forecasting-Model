...
# installed.
TCL_PREFIX='/Users/gagan/project/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/gagan/project/env'
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/gagan/project/env/lib -L/Users/gagan/project/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/gagan/project/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/gagan/project/env/include'
...
TCL_PACKAGE_PATH='{/Users/gagan/project/env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/gagan/project/env/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/gagan/project/env/lib/libtclstub8.6.a'
